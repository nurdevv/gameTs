...
export const QRCodeModal: FunctionComponent<{
    isOpen: boolean;
    onClose: () => void,
    walletInfo: WalletInfoRemote | null
}> = ({isOpen, onClose, walletInfo}) => {
    ...
    return <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
            ...
            <ModalBody display="flex" flexDirection="column" alignItems="center">
                ...
                <Button onClick={() => window.open(walletConnectionURL, '_blank')} w="100%"
                        my="4">Open {walletInfo?.name}</Button>
            </ModalBody>
        </ModalContent>
    </Modal>
}